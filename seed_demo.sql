...
INSERT INTO events (id, case_id, date, time, type, court, place, open, level,
                    created_by, updated_by, updated_at) VALUES
('demo-joho-0', 'demo-case-joho', '2026-07-08', '10:30', '第1回口頭弁論', 'サンプル地方裁判所', '101号法廷', 1, NULL,        'demo','demo','2026-08-20T00:00:00.000Z'),
('demo-joho-1', 'demo-case-joho', '2026-08-25', '10:30', '第2回口頭弁論', 'サンプル地方裁判所', '101号法廷', 1, 'はじめて向け','demo','demo','2026-08-20T00:00:00.000Z'),
('demo-joho-2', 'demo-case-joho', '2026-09-10', '10:30', '第3回口頭弁論', 'サンプル地方裁判所', '101号法廷', 1, '短時間',     'demo','demo','2026-08-20T00:00:00.000Z'),
('demo-roudou-1',   'demo-case-roudou',   '2026-09-03', '13:30', '当事者尋問', 'サンプル地方裁判所', '203号法廷', 1, '見ごたえあり','demo','demo','2026-08-20T00:00:00.000Z'),
('demo-hikoukai-1', 'demo-case-hikoukai', '2026-09-03', '15:00', '弁論準備',   'サンプル地方裁判所', '第3準備室', 0, NULL,        'demo','demo','2026-08-20T00:00:00.000Z');

-- 訴訟資料の見本（ファイルは付けず、目録＋箇条書き＋要約だけ）
INSERT INTO materials (id, case_id, event_id, title, side, kind, filed_on,
                       url, r2_key, file_name, file_size, mime, claims, summary,
